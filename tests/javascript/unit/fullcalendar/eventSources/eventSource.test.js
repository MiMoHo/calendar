...
describe('fullcalendar/eventSource test suite', () => {
	...
	it('should provide an eventSource function to provide events - fetch new timerange', async () => {
		...
		expect(eventSourceFunction).toHaveBeenNthCalledWith(1, [{ calendarObjectId: 1 }, { calendarObjectId: 2 }], calendar, start, end, { calendarJsTimezone: true, tzid: 'America/New_York' }, null)
	...
	it('should provide an eventSource function to provide events - existing timerange - unknown timezone', async () => {
		...
		expect(eventSourceFunction).toHaveBeenCalledTimes(1)
		expect(eventSourceFunction).toHaveBeenNthCalledWith(1, [{ calendarObjectId: 1 }, { calendarObjectId: 2 }], calendar, start, end, { calendarJsTimezone: true, tzid: 'UTC' }, null)
