OC.L10N.register(
    ...
    "Your appointment \"%s\" with %s has been accepted" : "Ihre Termin \"%s\" mit %s wurde angenommen.",
    "Dear %s, your booking has been accepted." : "Hallo %s, Ihre Buchung wurde angenommen.",
    ...
    "Today" : "Heute",
    "Day" : "Tag",
    "(Day {current}/{total})" : "(Tag {current}/{total})",
    "Week" : "Woche",
    "Month" : "Monat",
    "Year" : "Jahr",
    "List" : "Liste",
    "Filter events …" : "Termine filtern …",
    ...
    "Delegated to you by" : "An Sie übertragen von",
    ...
    "Export" : "Exportieren",
    "Failed to export the calendar" : "Kalender konnte nicht exportiert werden",
    ...
    "Deck" : "Deck",
    "Tasks" : "Aufgaben",
    "Delegated by {name} (read-only)" : "Übertragen von {name} (schreibgeschützt)",
    "Delegated by {name}" : "Übertragen von {name}",
    ...
    "Deleting share link …" : "Freigabe-Link wird gelöscht …",
    ...
    "This calendar supports neither events, tasks nor journal entries." : "Dieser Kalender unterstützt weder Termine, Aufgaben noch Journaleinträge.",
    ...
    "Never show me as busy (set this calendar to transparent)" : "Mich immer als verfügbar anzeigen (statt standardmäßig beschäftigt)",
    "Update existing events?" : "Bestehende Termine anpassen?",
    "Show events as" : "Termine anzeigen als",
    "Add a description" : "Beschreibung hinzufügen",
    "Event color" : "Terminfarbe",
    "Organizer of the event" : "Organisator des Termins",
    "Organizer" : "Organisator",
    "As delivered by the source" : "Wie von der Quelle geliefert",
    "The events of this calendar cannot be edited themselves; this setting overrides the busy status they were delivered with" : "Die Termine dieses Kalenders können nicht direkt bearbeitet werden; diese Einstellung überschreibt den Verfügbar/Beschäftigt-Status, mit dem sie geliefert wurden",
    "Should all existing events of this calendar also be shown as available?" : "Sollen auch alle bestehenden Termine dieses Kalenders als verfügbar angezeigt werden?",
    "Should all existing events of this calendar also be shown as busy?" : "Sollen auch alle bestehenden Termine dieses Kalenders als beschäftigt angezeigt werden?",
    "Keep events unchanged" : "Termine unverändert lassen",
    "Update events" : "Termine anpassen",
    "_%n event updated_::_%n events updated_" : ["%n Termin angepasst","%n Termine angepasst"],
    "_%n event could not be updated_::_%n events could not be updated_" : ["%n Termin konnte nicht angepasst werden","%n Termine konnten nicht angepasst werden"],
    "All events already match the calendar setting" : "Alle Termine entsprechen bereits der Kalendereinstellung",
    "Failed to update the events of the calendar" : "Die Termine des Kalenders konnten nicht angepasst werden",
    "Default reminder for part-day events" : "Standarderinnerung für halbtägige Termine",
    "Select default reminder" : "Standarderinnerung auswählen",
    "Default reminder for full-day events" : "Standarderinnerung für ganztägige Termine",
    "These reminders will be automatically added to new events created in this calendar" : "Diese Erinnerungen werden automatisch neuen Terminen, die in diesem Kalender erstellt werden, hinzugefügt",
    ...
    "Event legend" : "Terminlegende",
    "Calendar events are styled to convey additional information at a glance." : "Kalendertermine sind so gestaltet, dass sie auf einen Blick weitere Informationen vermitteln.",
    "Free / Busy" : "Verfügbar / Beschäftigt",
    "Busy" : "Beschäftigt",
    "Your time is marked as occupied" : "Der Zeitbereich ist als nicht verfügbar markiert",
    "Free" : "Verfügbar",
    "Your time is still available" : "Der Zeitbereich ist als verfügbar markiert",
    "Confirmed: events taking place are shown in bold" : "Angenommen: Stattfindende Termine werden fett dargestellt",
    "Events that have already ended keep their formatting and are shown in a lighter color" : "Bereits beendete Termine behalten ihre Formatierung und werden in hellerer Farbe dargestellt",
    "Indicators" : "Indikatoren",
    "The thin line above the title shows the duration of the event in relation to one day" : "Die dünne Linie über dem Titel zeigt die Dauer des Termins im Verhältnis zu einem Tag",
    "Participation status" : "Teilnahmestatus",
    "Accepted" : "Angenommen",
    "Accepted: you confirmed your attendance" : "Angenommen: Sie haben Ihre Teilnahme bestätigt",
    "Tentative" : "Vorläufig",
    "Tentative: your participation is uncertain" : "Vorläufig: Ihre Teilnahme ist unsicher",
    "Invited" : "Eingeladen",
    "Invited: you have not yet responded to this invitation" : "Eingeladen: Sie haben bislang auf die Einladung noch nicht reagiert",
    "Declined" : "Abgelehnt",
    "Declined: you declined this event" : "Abgelehnt: Sie haben diesen Termin abgelehnt",
    "All declined" : "Alle abgelehnt",
    "All declined: all participants declined" : "Alle abgelehnt: Alle Teilnehmer haben abgelehnt",
    "Icons" : "Symbole",
    "Attendees" : "Teilnehmer",
    "This event has one or more attendees" : "Dieser Termin hat einen oder mehrere Teilnehmer",
    "Past events" : "Vergangene Termine",
    "Past event" : "Vergangener Termin",
    "Events that have already ended are shown with a more faded background" : "Bereits beendete Termine werden mit einem blasseren Hintergrund dargestellt",
    ...
    "Some calendars are disabled because this file contains {types}." : "Einige Kalender sind deaktiviert, da diese Datei {types} enthält.",
    ...
    "{email} will no longer be able to act on your behalf." : "{email} wird nicht mehr in Ihrem Namen handeln können.",
    "Revoke" : "Widerrufen",
    "Viewer" : "Betrachter",
    "Editor" : "Editor",
    "Could not revoke access." : "Der Zugriff konnte nicht widerrufen werden.",
    "Access revoked successfully." : "Zugriff erfolgreich entzogen.",
    "{name} can now view your calendars." : "{name} kann jetzt Ihre Kalender einsehen.",
    "{name} can now act on your behalf." : "{name} kann nun in Ihrem Namen handeln.",
    "Could not add delegate." : "Delegierter konnte nicht hinzugefügt werden.",
    "Could not load delegates." : "Delegierte konnten nicht geladen werden.",
    "Delegates" : "Delegierte",
    "Allow users to manage your calendar events and invitations on your behalf." : "Ermöglichen Sie es Benutzern, Ihre Kalenderereignisse und Einladungen in Ihrem Namen zu verwalten.",
    "Loading delegates…" : "Delegierte werden geladen …",
    "Revoke access" : "Zugriff widerrufen",
    "No delegates yet." : "Noch keine Delegierten.",
    "Add delegate" : "Delegierten hinzufügen",
    "Revoke access?" : "Zugriff widerrufen?",
    "Search for a user…" : "Nach einem Benutzer suchen …",
    "No users found" : "Keine Benutzer gefunden",
    "Choose whether they can view and edit events, or only view them." : "Auswählen, ob sie Termine anzeigen und bearbeiten oder nur anzeigen können.",
    "Add as viewer" : "Als Betrachter hinzufügen",
    "Add as editor" : "Als Bearbeiter hinzufügen",
    ...
    "Import calendar file" : "Kalenderdatei importieren",
    ...
    "Public – shown on profile page" : "Öffentlich – wird auf der Profilseite angezeigt",
    "Private – only accessible via link" : "Privat – nur über einen Link erreichbar",
    ...
    "Calendars to check for conflicts" : "Kalender die auf Konflikte überprüft werden sollen",
    "Visibility" : "Sichtbarkeit",
    "Booking availability" : "Buchungsverfügbarkeit",
    "to" : "bis",
    ...
    "Buffer before the event" : "Puffer vor dem Termin",
    "Buffer after the event" : "Puffer nach dem Termin",
    ...
    "Talk conversation for event" : "Talk-Unterhaltung für einen Termin",
    ...
    "on" : "am",
    "at" : "um",
    "Default reminder of calendar" : "Standarderinnerung des Kalenders",
    "Amount" : "Menge",
    "before at" : "vorher um",
    "after at" : "nachher um",
    "before the event" : "vorher",
    "after the event" : "nachher",
    "Before or after the event" : "Vor oder nach dem Termin",
    "Alarm date and time" : "Datum und Uhrzeit des Alarms",
    ...
    "You are about to navigate to {link}. Are you sure to proceed?" : "Sie sind dabei, zu {link} zu navigieren. Fortfahren?",
    ...
    "Proceed" : "Fortsetzen",
    "Upload files as attachments" : "Dateien als Anhänge hochladen",
    ...
    "Failed to deliver invitation" : "Einladung nicht zugestellt",
    "{role} with reply" : "{role} mit Antwort",
    "{role} without reply" : "{role} ohne Antwort",
    ...
    "{name} (delegated by {delegator})" : "{name} (delegiert durch {delegator})",
    "Duration" : "Dauer",
    ...
    "_{i} day_::_{i} days_" : ["{i} Tag","{i} Tage"],
    "_{i} hour_::_{i} hours_" : ["{i} Stunde","{i} Stunden"],
    "_{i} minute_::_{i} minutes_" : ["{i} Minute","{i} Minuten"],
    "Days" : "Tage",
    "Hours" : "Stunden",
    "Minutes" : "Minuten",
    ...
    "Available time slots" : "Verfügbare Zeitfenster",
    ...
    "Search for attendees" : "Suche nach Teilnehmenden",
    "(organizer)" : "(Organisator)",
    ...
    "To send out invitations and handle responses, [linkopen]add your email address in personal settings[linkclose]." : "Um Einladungen zu versenden und Antworten hierauf zu verarbeiten, [linkopen] Ihre E-Mail-Adresse in den persönlichen Einstellungen hinzufügen[linkclose].",
    ...
    "Repeat event ({position})" : "Termin wiederholen ({position})",
    "Set repetition" : "Wiederholung festlegen",
    "never" : "Niemals",
    "on date" : "zum Datum",
    "after" : "Nach Anzahl",
    "End repeat" : "Wiederholung beenden",
    "End repeat date" : "Letztes Wiederholungsdatum",
    ...
    "first" : "ersten",
    "Week occurrence" : "Wochen-Vorkommen",
    ...
    "Repeat every" : "Wiederholungsintervall",
    ...
    "Repeat frequency" : "Wiederholungsfrequenz",
    ...
    "Search for resources" : "Nach Ressourcen suchen",
    "Projector" : "Projektor",
    ...
    "(delegated by {name})" : "(delegiert durch {name})",
    ...
    "Contact your server administrator to resolve this issue." : "Bitte an die Administration wenden, um dieses Problem zu lösen.",
    ...
    "This booking link is no longer valid" : "Dieser Bestätigungslink ist nicht mehr gültig",
    "The confirmation link has expired or has already been used. Please contact the organizer to rebook." : "Der Bestätigungslink ist abgelaufen oder wurde bereits verwendet. Bitte den Veranstalter kontaktieren, um umzubuchen.",
    "Confirm your appointment" : "Bestätigen Sie Ihren Termin",
    "Could not confirm the appointment. Please try again later or contact the organizer." : "Termin konnte nicht bestätigt werden. Bitte später erneut versuchen oder wenden Sie sich an den Organisator.",
    ...
    "Allow forwarding" : "Weiterleiten erlauben",
    ...
    "Failed to fetch free/busy data" : "Verfügbarkeitsdaten konnten nicht abgerufen werden",
    "Selected" : "Ausgewählt",
    ...
    "_%n day after the event at {formattedHourMinute}_::_%n days after the event at {formattedHourMinute}_" : ["%n Tag nach dem Start des Termins um {formattedHourMinute}","%n Tage nach dem Start des Termins um {formattedHourMinute}"],
    ...
    "_%n week after the event at {formattedHourMinute}_::_%n weeks after the event at {formattedHourMinute}_" : ["%n Woche nach dem Start des Termins um {formattedHourMinute}","%n Wochen nach dem Start des Termins um {formattedHourMinute}"],
    ...
    "You are not allowed to edit this event as an attendee." : "Keine Berechtigung, diesen Termin als Teilnehmer zu bearbeiten.",
    "W" : "W",
    "%n more" : "%n weitere",
    "No events to display" : "Keine Termine vorhanden",
    "{startDate} to {endDate}" : "{startDate} bis {endDate}",
    "{startDateTime} to {endTime}" : "{startDateTime} bis {endTime}",
    "{startDateTime} to {endDateTime}" : "{startDateTime} bis {endDateTime}",
    "{title}, All day: {timeDescription}" : "{title}, Ganztägig: {timeDescription}",
    "{title}, All day" : "{title}, Ganztägig",
    "{title}, {timeDescription}" : "{title}, {timeDescription}",
    "All participants declined" : "Alle Teilnehmer haben abgelehnt",
    "Participation not confirmed" : "Teilnahme unbestätigt",
    ...
    "Event link copied to clipboard" : "Termin-Link in die Zwischenablage kopiert",
    "Failed to copy event link" : "Termin-Link konnte nicht kopiert werden",
    ...
    "Take this event into account when calculating free-busy information." : "Diesen Termin bei der Berechnung der Verfügbarkeit berücksichtigen.",
    ...
    "Could not load delegated calendars. Make sure the server supports calendar delegation." : "Delegierte Kalender konnten nicht geladen werden. Stellen Sie sicher, dass der Server die Kalenderdelegierung unterstützt.",
