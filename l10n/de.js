OC.L10N.register(
    ...
    "Dear %s, your booking has been accepted." : "Hallo %s, dein Buchung wurde angenommen.",
    ...
    "Delegated to you by" : "An dich übertragen von",
    ...
    "Accepted" : "Angenommen",
    "Accepted: you confirmed your attendance" : "Angenommen: Du hast deine Teilnahme bestätigt",
    "Tentative" : "Vorläufig",
    "Tentative: your participation is uncertain" : "Vorläufig: Deine Teilnahme ist unsicher",
    "Invited" : "Eingeladen",
    "Invited: you have not yet responded to this invitation" : "Eingeladen: Du hast bislang auf die Einladung noch nicht reagiert",
    "Declined" : "Abgelehnt",
    "Declined: you declined this event" : "Abgelehnt: Du hast diesen Termin abgelehnt",
    ...
    "{name} can now view your calendars." : "{name} kann jetzt deine Kalender einsehen.",
    "{name} can now act on your behalf." : "{name} kann nun in deinem Namen handeln.",
    ...
    "Allow users to manage your calendar events and invitations on your behalf." : "Ermögliche es Benutzern, deine Kalenderereignisse und Einladungen in deinem Namen zu verwalten.",
    ...
    "Alarm date and time" : "Datum und Zeit wählen",
    ...
    "{name} (delegated by {delegator})" : "{name} (delegiert von {delegator})",
    "Duration" : "Dauer",
    ...
    "(delegated by {name})" : "(delegiert von {name})",
    ...
    "Confirm your appointment" : "Bestätige deinen Termin",
    "Could not confirm the appointment. Please try again later or contact the organizer." : "Termin konnte nicht bestätigt werden. Bitte später erneut versuchen oder wende dich an den Organisator.",
    ...
    "Could not load delegated calendars. Make sure the server supports calendar delegation." : "Delegierte Kalender konnten nicht geladen werden. Sicherstellen, dass der Server die Kalenderdelegierung unterstützt.",
